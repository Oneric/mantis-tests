...
namespace mantis_tests
{
    public class ProjectManagementHelper : HelperBase  
    {
        ...
        public List<ProjectData> GetProjectList()
        {
            ...
            foreach (IWebElement element in elements)
            {
                projectList.Add(new ProjectData()
                {
                    ...
                    Status = element.FindElement(By.XPath("./td[2]")).Text,
                    ActivityState = IsElementPresent(element, By.XPath("./td[3]/i")),
                    ViewState = element.FindElement(By.XPath("./td[4]")).Text,
        ...
        public void FillProjectForm(ProjectData project)
        {
            ...
            SetSelectByText(By.Name("status"), project.Status);
            SetSelectByText(By.Name("view_state"), project.ViewState);
